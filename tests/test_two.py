...
ss.show(data='test')
# ss.show()
res = ss.find_image(template_path=r"C:\Users\adriankubinyete\Desktop\coding\srbg-python\src\utils\collection.png", window_size={'width': 816, 'height':638 }, threshold=0.8)
